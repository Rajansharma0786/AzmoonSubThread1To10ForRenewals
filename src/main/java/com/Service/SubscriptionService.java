...
public class SubscriptionService {
	...
	public void saveRenTypeInBilling(List<TblSubscription> subscription,String status)
	{
		try 
		{
...
//				System.out.println("Control inside");
				...
				System.out.println("REN ANi Save In Table Billing"+getRecord.getAni() +"&Status is"+status);
